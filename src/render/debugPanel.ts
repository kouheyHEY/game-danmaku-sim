...
const STYLE = `
#debug { position: fixed; top: 6px; left: 6px; z-index: 9999; font: 11px PixelMplus12, monospace; touch-action: auto; }
#debug .bar { display: inline-flex; gap: 6px; align-items: center; }
#debug button { font: 11px PixelMplus12, monospace; color: #e6ebf5; background: #1b2130; border: 1px solid #3b4253; border-radius: 5px; padding: 4px 7px; cursor: pointer; }
#debug button:active { background: #2a3346; }
#debug .toggle { background: #2b2130; border-color: #6b3b53; }
#debug .body { display: none; flex-wrap: wrap; gap: 4px; max-width: 230px; max-height: calc(100vh - 50px); overflow-y: auto; margin-top: 5px; padding: 6px; background: rgba(11,13,18,0.9); border: 1px solid #232a3a; border-radius: 6px; }
